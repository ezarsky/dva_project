...
data_path = "../airline_data/2019top30data2.parquet"
...
# incorporate modeling and metrics in node and edge info
# create Graph
...
def route_score(avg_delay, std_delay, num_flights):
    ...
    if num_flights < 5:
        return route_scores[3]  # return insufficient volume if less than 5 flights
    else:
